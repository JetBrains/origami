...
getPalette product =
    case product of
        ...
        DotPeek -> [ "#147591", "#786bfb", "#e14ce3" ]
        DotTrace -> [ "#fc1681", "#786bfb", "#e14ce3" ]
        Rider -> [ "#88083b", "#b2009b", "#f69102" ]
        TeamCity -> [ "#156e95", "#9062f7", "#46e869" ]
        YouTrack -> [ "#156e95", "#9062f7", "#fc378c" ]
        UpSource -> [ "#22b1ef", "#9062f7", "#fd8224" ]
        Hub -> [ "#156e95", "#a300f7", "#ffffff" ]
